...
namespace SqlEngine
{
    class sCloud
    {
        ...
        public static int checkCloudState(string vCurrCloudName)
        {
            ...
            string vSqlURL = prepareCloudQuery(vCurrCloudName, libCHouse.getCloudSqlCheck(vCurrCloud.CloudType));
        ...
        public static IEnumerable<CloudObjects> getCloudTableList(string vCurrCloudName)
        {
            ...
            vSqlURL = prepareCloudQuery(vCurrCloudName, libCHouse.getCloudSqlTable(vCurrCloud.CloudType));
        ...
        public static IEnumerable<CloudObjects> getCloudViewList(string vCurrCloudName)
        {
            ...
            vSqlURL = prepareCloudQuery(vCurrCloudName, libCHouse.getCloudSqlView(vCurrCloud.CloudType));
        ...
        public static IEnumerable<ObjectsAndProperties> getObjectProperties(string vCurrCloudName, string vObjName)
        {
            ...
            vSqlURL = prepareCloudQuery(vCurrCloudName, libCHouse.getCloudColumns(vCurrCloud.CloudType));
